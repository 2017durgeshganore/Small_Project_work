...
public class Maroc_Shop extends Canvas{
	...
	public static void main(String[] args) throws Exception {
		...
		PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\dell\\Downloads\\Health+Programming+Lesson_Materials\\durgesh.pdf"));
		...
		Thread.sleep(1000);
		System.out.println("😃 I am here to help you purachase your order");
		Thread.sleep(2000);
		...
		while(response.equals("Yes"))
		{
			...
			else if(customer_choice.equals("3"))
			{
				...
				com.itextpdf.text.Image image2 = com.itextpdf.text.Image.getInstance("C:\\Users\\dell\\Downloads\\Health+Programming+Lesson_Materials\\logo.png");
				...
				Thread.sleep(2000);
				System.out.println("😃 Hoew many Cookies would you like to order?");
				...
				for(int y = 0;y < cookie_no; y++)
				{
					...
					System.out.println(Colors.RESET + "How many of this cookiw would you like to order?");
					...
					else if(cookie.equals("Pistacio Rose"))
					{
