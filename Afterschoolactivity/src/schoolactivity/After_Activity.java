...
public class After_Activity extends Canvas{
	...
	{
		Image activity = new ImageIcon("C:\\Users\\dell\\Downloads\\Materials_Programming+++Mathematics+++Water+Science+++Education+++Health\\Lesson 20 Materials\\Picture Example\\Picture2.png").getImage();
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(Colors.DARK_RED +"*******************************************************************************************************************************************************************************");
		...
		do
		{
			...
			if(response.equals("Administrator"))
			{
				...
				{
					String file_path = "C:\\Users\\dell\\Downloads\\Materials_Programming+++Mathematics+++Water+Science+++Education+++Health\\Lesson 20 Materials\\";
		...
		{
			//creating a pie chart to act as check out counter
